...
Pager Duty service config module, context used by the Pager Duty service.
'''
...
Args:
    ...
    events_url (str): The Pager Duty events url to publish to.
    routing_key (str): The Pager Duty routing key.
